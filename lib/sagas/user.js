...
function fromWatchSetUserData(action) {
  var _action$config, getFilteredElements, joinedModeCollectionNames, requestTransactions, _action$user, active, id;

  return regeneratorRuntime.wrap(function fromWatchSetUserData$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _action$config = action.config, getFilteredElements = _action$config.getFilteredElements, joinedModeCollectionNames = _action$config.joinedModeCollectionNames, requestTransactions = _action$config.requestTransactions, _action$user = action.user, active = _action$user.active, id = _action$user.id;
        ...
        case 4:
          ...
          _context.next = 8;
          return (0, _effects.put)(requestTransactions('GET', [{
            ...
            extra: { getFilteredElements: getFilteredElements },
            tag: 'sign'
          }));
  ...
  return regeneratorRuntime.wrap(function fromWatchMergeNormalizerGetSignActionData$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 17:
          _context2.next = 19;
          return (0, _effects.select)(_transactionsAuthorizationState.getAuthorizedModes, action.extra.getFilteredElements);
