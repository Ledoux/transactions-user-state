...
var _require$default = require('transactions-authorization-state').default,
    getAuthorizedLinks = _require$default.getAuthorizedLinks,
    setAuthorizationIdsByModeName = _require$default.setAuthorizationIdsByModeName,
    setAuthorizationLinks = _require$default.setAuthorizationLinks,
    setAuthorizationSelectedMode = _require$default.setAuthorizationSelectedMode,
    getNewAuthorizedModes = _require$default.getNewAuthorizedModes;

var _require$default2 = require('transactions-interface-state').default,
    IS_UNDER_CONSTRUCTION = _require$default2.IS_UNDER_CONSTRUCTION,
    getLocationSearch = _require$default2.getLocationSearch;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          _context2.next = 11;
          return (0, _effects.put)(setAuthorizationIdsByModeName(idsByModeName));
        ...
        case 17:
          _context2.next = 19;
          return (0, _effects.select)(getNewAuthorizedModes);

        case 19:
          modes = _context2.sent;
          links = getAuthorizedLinks(modes);
          _context2.next = 23;
          return (0, _effects.put)(setAuthorizationLinks(links, modes));
