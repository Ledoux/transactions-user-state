...
var SignForm = exports.SignForm = function SignForm(WrappedComponent) {
  var _SignForm = function (_Component) {
    ...
    function _SignForm() {
      ...
      var _this = _possibleConstructorReturn(this, (_SignForm.__proto__ || Object.getPrototypeOf(_SignForm)).call(this));

      var _getReturnState = (0, _return.getReturnState)(),
    ...
    _createClass(_SignForm, [{
      ...
      value: function render() {
        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { state: this.state }));
      }
    }]);
